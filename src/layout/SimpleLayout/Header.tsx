...
// assets
import { ArrowDown2, ArrowUp2, HambergerMenu, Minus } from 'iconsax-react';

import ProfilePage from 'layout/DashboardLayout/Header/HeaderContent/Profile';
            ...
            >
              {isAuthenticated ? (
                <Stack direction="row" alignItems="center" spacing={3}>
                  <Typography sx={{ fontSize: 20 }}>Hello: {userName}</Typography>
                  <ProfilePage />
                </Stack>
              ) : (
                <Stack direction="row" alignItems="right" spacing={3}>
                  <Button component={Links} disableElevation color="success" size="large" variant="contained" href={'/login'}>
                    Login
                  </Button>
                  <Button component={Links} disableElevation color="info" size="large" variant="contained" href={'/register'}>
                    Register
                  </Button>
                </Stack>
              )}
